...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "confirm_delete_song" : (title) => "Vuoi eliminare definitivamente \"${title}\"?\nVerrà rimossa da tutte le playlist.",
    ...
    "create_dialog_body" : MessageLookupByLibrary.simpleMessage("Le canzoni vanno scritte nel formato ChordPro.\nAd esempio:"),
    ...
    "export_error" : (error) => "Errore esportazione: ${error}",
    ...
    "import_error" : (error) => "Errore importazione: ${error}",
    ...
    "song_imported" : (title) => "\"${title}\" importata!",
    "song_updated" : (title) => "\"${title}\" aggiornata!",
    "songs" : MessageLookupByLibrary.simpleMessage("brani"),
    "songs_imported" : (count) => "${count} canzoni importate!",
    ...
    "upload_dialog_body" : MessageLookupByLibrary.simpleMessage("Hai modificato correttamente il testo e gli accordi?\nHai seguito lo standard ChordPro?\nNon ci sono errori ortografici?"),
